...
class ScrollWatcher {
	...
	//========================================================================================================================================================
			// Перевіряємо, чи має елемент атрибут data-watch зі значенням 'navigator'
		if (targetElement.dataset.watch === 'navigator') {
			// Знаходимо елемент меню, який відповідає блоку navigator
			let menuLinkSelector = `[data-goto=".${targetElement.classList.value}"]`;
			let menuLink = document.querySelector(menuLinkSelector);
	
			// Додаємо клас ._active-link, якщо елемент меню існує
			menuLink ? menuLink.classList.add('_active-link') : null;
		  }
	//========================================================================================================================================================
	...
	//========================================================================================================================================================
		...
		if (targetElement.dataset.watch === 'navigator') {
			...
			// Забираємо клас ._active-link, якщо елемент меню існує
			menuLink ? menuLink.classList.remove('_active-link') : null;
		  }
	//========================================================================================================================================================
